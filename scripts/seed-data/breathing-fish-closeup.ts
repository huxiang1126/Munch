export const breathingFishCloseup = {
  ...
  name: "会呼吸的鱼 · 特写",
  description:
    "上传人物参考图，生成黄金时段野花草地中的 surreal 竖构图头肩特写：低机位微仰拍、飞鱼掠过镜头、发丝被风吹拂，整体呈现高定时装与梦境自然的混合气质。",
  category: "portrait" as const,
  tags: ["超现实", "特写", "飞鱼", "黄金时段", "高定肖像"],
  thumbnail_url: null,
  thumbnail_path: null,
  ...
  variables: [
    ...
    },
    {
      ...
      options: [
        {
          value: "one or two orange-red flying fish sweeping close past the lens with directional motion blur",
          label: "单次掠过",
        },
        {
          value: "multiple red and gold flying fish layered around the face and foreground with dramatic scale",
          label: "多层环绕",
        },
        {
          value: "a denser swirl of luminous red-gold flying fish crossing the frame diagonally",
          label: "更强梦境感",
        },
      ],
      defaultValue: "multiple red and gold flying fish layered around the face and foreground with dramatic scale",
    },
    {
      id: "tone_finish",
      name: "色调气质",
